...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3I.pack(_x.feedback.next_frontier.header.seq, _x.feedback.next_frontier.header.stamp.secs, _x.feedback.next_frontier.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.next_frontier.header.seq, _x.feedback.next_frontier.header.stamp.secs, _x.feedback.next_frontier.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.feedback.next_frontier.pose.position.x, _x.feedback.next_frontier.pose.position.y, _x.feedback.next_frontier.pose.position.z, _x.feedback.next_frontier.pose.orientation.x, _x.feedback.next_frontier.pose.orientation.y, _x.feedback.next_frontier.pose.orientation.z, _x.feedback.next_frontier.pose.orientation.w, _x.feedback.base_position.header.seq, _x.feedback.base_position.header.stamp.secs, _x.feedback.base_position.header.stamp.nsecs,) = _struct_7d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
