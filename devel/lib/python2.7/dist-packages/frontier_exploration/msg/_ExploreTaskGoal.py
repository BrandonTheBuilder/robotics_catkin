...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.explore_center.header.seq, _x.explore_center.header.stamp.secs, _x.explore_center.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d.pack(_x.explore_center.point.x, _x.explore_center.point.y, _x.explore_center.point.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.explore_center.header.seq, _x.explore_center.header.stamp.secs, _x.explore_center.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.explore_center.point.x, _x.explore_center.point.y, _x.explore_center.point.z,) = _struct_3d.unpack(str[start:end])
      return self
